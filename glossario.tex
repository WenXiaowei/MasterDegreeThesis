...
\newglossaryentry{ateg}
{
    ...
    sort= ate,
    description={ATE is ...} % todo add/fix the definition
}
...
\newglossaryentry{rteg}
{
    ...
    sort= rte,
    description={RTE is ...} % todo add/fix the definition
}
...
{
    name=\glslink{gnss}{RTE},
    text= Global Navigation Satellite System,
    sort= gnss,
    description={GNSS is ...} % todo add/fix the definition
}
