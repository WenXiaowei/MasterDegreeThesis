...
%**************************************************************
    \frontmatter
    \input{pages/frontespizio}
    \input{pages/colophon}
    \input{pages/dedica}
    \input{pages/sommario}
    \input{pages/ringraziamenti}
    \input{pages/indici}
    \cleardoublepage
...
%**************************************************************
    \mainmatter
    \input{./chapters/1_0_introduction.tex}             % Introduzione         % Kick-Off
    \input{./chapters/2_0_theoretical_foundations.tex}             % Product Prototype
    \input{./chapters/3_0_datasets.tex}             % Product Design Freeze e SOP
    \input{./chapters/4_0_state_of_the_art.tex}
    \input{./chapters/5_0_experiments.tex}
    \input{./chapters/6_0_implementations.tex}
    \input{./chapters/7_0_conclusions.tex}             % Conclusioni
%**************************************************************
% Materiale finale
%**************************************************************
    \backmatter
